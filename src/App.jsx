  ...
  return (
    <div className='h-screen w-full px-5 bg-gray-200 flex flex-col overflow-y-auto'>
      ...
      <form onSubmit={handelAddTask} className=' w-full md:w-[97%] flex-col  md:flex-row  ' >
        <input  className='md:w-[84%] w-full mt-5 border-2 border-blue-500 hover:border-blue-700 outline-0  rounded-lg h-11.5  p-2   'onChange={(e)=>setinputvalue(e.target.value)} value={inputvalue}  type="text" placeholder='Add new task... '  />
